...
/** Ícone da marca BuildersWay (gradiente assinatura roxo -> azul). */
export function Logomark({ size = 24 }: LogomarkProps) {
  return (
    <svg
      ...
      aria-hidden="true"
      fill="url(#bw-logo-gradient)"
    >
      <defs>
        <linearGradient id="bw-logo-gradient" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#9c75ff" />
          <stop offset="1" stopColor="#5e9bff" />
        </linearGradient>
      </defs>
